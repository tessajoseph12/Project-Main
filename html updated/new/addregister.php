...
{
$r="select * from tbl_reg where phone_number='$phone_number'";
$result=mysqli_query($con,$r);
...
if($num==1)
	...
	<script>alert("Phone number already exists");
...
$sq="insert into tbl_reg(login_id,name,phone_number,address,main_city) values('$n','$name','$phone_number','$address','$main_city')";
