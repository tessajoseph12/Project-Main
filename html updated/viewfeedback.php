						...
						<nav id="nav">
							<ul>
								...
								<li><a href="#">Channels</a>
									...
									<li><a href="#channel.php">Update Channel</a></li>
								...
								<li class="current"><a href="viewfeedback.php"> View Feedback</a></li>
...
echo "<h2><center>VIEW FEEDBACK </h2>";
  echo "<tr><th><b>Login id</b></th><th><b>Content</b></th><th><b>status</b></th></tr>";
  echo "<hr>";
